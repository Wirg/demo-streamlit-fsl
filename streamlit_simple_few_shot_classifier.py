...
def get_fsl_classifier_from_catalog_dataframe(catalog_dataframe: pd.DataFrame):
    ...
    fsl_classifier.set_catalog(
        image_dataset_from_paths(list(catalog_dataframe.image_path)), catalog_dataframe.label
    )
...
predictions = fsl_classifier.predictions_to_classes(fsl_classifier.predict(
